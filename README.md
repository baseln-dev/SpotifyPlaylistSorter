...
- Base path is preconfigured as `/SpotifyPlaylistSorter` in production
...
- Spotify redirect URI for production: `https://<yourusername>.github.io/SpotifyPlaylistSorter/callback`

## Spotify app settings (required)
- Add both redirect URIs in the Spotify dashboard:
	- Local: `http://127.0.0.1:5173/callback`
	- GitHub Pages: `https://<yourusername>.github.io/SpotifyPlaylistSorter/callback`
